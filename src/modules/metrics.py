...
def score(
    ...
    for particle_type, totals in results.items():
        ...
        scores[particle_type]= fbeta

        if log_more:
            print("{:<25} tp: {:<4} fp: {:<4} fn: {:<4} prec: {:<6.2f} recall: {:<6.2f} F-beta: {:<6.2f}".format(
                particle_type, tp, fp, fn, precision, recall, fbeta))
